...
public class FilteredSAMLGroupMembershipMapper extends AbstractSAMLProtocolMapper implements SAMLAttributeStatementMapper {
    public static final String CONF_SINGLE_GROUP_ATTRIBUTE = "single";
    public static final String CONF_FULL_PATH = "full.path";
    public static final String CONF_EXCLUDE_PATTERN = "exclude.pattern";

    public static final String PROVIDER_ID = "saml-filtered-group-membership-mapper";
    ...
    static {
        ...
        property = new ProviderConfigProperty();
        property.setName(CONF_SINGLE_GROUP_ATTRIBUTE);
    ...
    public void transformAttributeStatement(AttributeStatementType attributeStatement, ProtocolMapperModel mappingModel, KeycloakSession session, UserSessionModel userSession, AuthenticatedClientSessionModel clientSession) {
        String single = mappingModel.getConfig().get(CONF_SINGLE_GROUP_ATTRIBUTE);
        boolean singleAttribute = Boolean.parseBoolean(single);

        boolean fullPath = useFullPath(mappingModel);

        String regex = mappingModel.getConfig().get("exclude.pattern");
        ...
        userSession.getUser().getGroupsStream().forEach(group -> {
            ...
            if (!excludePattern.matcher(groupPath).find()) {
                if (fullPath) {
                    groupName = groupPath;
                } else {
    ...
    public static ProtocolMapperModel create(String name, String samlAttributeName, String nameFormat, String friendlyName, boolean singleAttribute) {
        ...
        config.put(CONF_SINGLE_GROUP_ATTRIBUTE, Boolean.toString(singleAttribute));
